...
namespace QuanLyHocSinh.DataSet.HocSinhTableAdapters {
    ...
    public partial class SinhVienTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [SinhVien] WHERE (([id] = @Original_id) AND ([name] = @Original_name) AND ((@IsNull_ngaysinh = 1 AND [ngaysinh] IS NULL) OR ([ngaysinh] = @Original_ngaysinh)) AND ((@IsNull_gioitinh = 1 AND [gioitinh] IS NULL) OR ([gioitinh] = @Original_gioitinh)) AND ((@IsNull_Diachi = 1 AND [Diachi] IS NULL) OR ([Diachi] = @Original_Diachi)) AND ([Malop] = @Original_Malop))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [SinhVien] ([name], [ngaysinh], [gioitinh], [Diachi], [Malop]) VALUES" +
                " (@name, @ngaysinh, @gioitinh, @Diachi, @Malop);\r\nSELECT id, name, ngaysinh, gio" +
                "itinh, Diachi, Malop FROM SinhVien WHERE (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [SinhVien] SET [name] = @name, [ngaysinh] = @ngaysinh, [gioitinh] = @gioitinh, [Diachi] = @Diachi, [Malop] = @Malop WHERE (([id] = @Original_id) AND ([name] = @Original_name) AND ((@IsNull_ngaysinh = 1 AND [ngaysinh] IS NULL) OR ([ngaysinh] = @Original_ngaysinh)) AND ((@IsNull_gioitinh = 1 AND [gioitinh] IS NULL) OR ([gioitinh] = @Original_gioitinh)) AND ((@IsNull_Diachi = 1 AND [Diachi] IS NULL) OR ([Diachi] = @Original_Diachi)) AND ([Malop] = @Original_Malop));
SELECT id, name, ngaysinh, gioitinh, Diachi, Malop FROM SinhVien WHERE (id = @id)";
        ...
        public virtual int Fill(HocSinh.SinhVienDataTable dataTable) {
        ...
        public virtual HocSinh.SinhVienDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            HocSinh.SinhVienDataTable dataTable = new HocSinh.SinhVienDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(HocSinh.SinhVienDataTable dataTable) {
